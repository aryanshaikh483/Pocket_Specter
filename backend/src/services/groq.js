...
// /**
//  * Returns an array of matched domains sorted by keyword hit count.
//  * Falls back to general_law if nothing matches.
//  */
...
//   // Return top match + any secondary domains with score > 0
//   return scores;
// };

// /**
//  * Formats detected domains into a system-prompt-friendly string.
//  */
...
//   // Detect domains and build context block
...
//     const response = await axios.post(
//       "https://api.groq.com/openai/v1/chat/completions",
//       { model: "llama-3.3-70b-versatile", messages, temperature: 0.2, max_tokens: 1024 },
//       {
//         headers: {
//           Authorization:  `Bearer ${process.env.GROQ_API_KEY}`,
//           "Content-Type": "application/json",
...
//   detectLegalDomains,   // export so routes/frontend can use it too
// };
